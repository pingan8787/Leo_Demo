...
function createCode() {
    ...
    if (checkCode) {
        ...
        for(var key in code){
        	if(typeof(code[key]) == 'number'){
		        html += '<img src="images/'+ code[key] +'.png">'
        	}
        }
        document.getElementById('checkCode').innerHTML = html
    }
}
  ...
  function randomPoint(min, max) {
    ...
    this.defaults = {
      ...
      pictureOver: '', // Path [src]
	        ...
	        sceneWidth: 260, // Canvas width
	        sceneHeight: 120, // Canvas height
	        radius: 10, // Radius of scratch zone
